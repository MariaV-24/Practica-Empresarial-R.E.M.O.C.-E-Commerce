...
?>
    ...
    <div class="content-wrapper">
        ...
        <div class="container-fluid">
            <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0 text-dark">Listar Artesanas</h1>
            </div><!-- /.col -->
    ...
    <div class="card-header">
        <h3 class="card-title"></h3>
            ...
            <div class="alert alert-success alert-dismissible fade show" style="<?php 
                    ...
                    ?>" role="alert">
                <strong>Artesana Modificado Correctamente</strong>
            ...
            <div class="alert alert-success alert-dismissible fade show" style="<?php 
                    ...
                    ?>" role="alert">
                <strong>Artesana Eliminado Correctamente</strong>
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>    
    ...
    <div class="card-body p-0">
        <div>
            <table class="table table-striped projects">
                ...
                <tbody>
                    <?php 
                        require('CRUD/listarArtesanas.php');
                    
                        while ($row = mysqli_fetch_array($resultado_artesana)) { ?>
                            <tr>
                        <td>
                            <a>
